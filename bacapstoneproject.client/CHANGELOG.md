...
- Create Angular project with ng: `ng new bacapstoneproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bacapstoneproject.client.esproj`).
